...
<div class="cart-summary">
	...
	<div class="cart-summary-button-container">
		{{#if needApproval}}
			<a id="btn-proceed-checkout-supervisor" class="cart-summary-button-proceed-checkout {{#if showProceedButton}} cart-summary-button-proceed-checkout-sb {{/if}}" href="#" data-hashtag="#" data-action="set-approval-order">
				{{translate 'Proceed to Checkout (Supervisor)'}}
			</a>			
		{{else}}
