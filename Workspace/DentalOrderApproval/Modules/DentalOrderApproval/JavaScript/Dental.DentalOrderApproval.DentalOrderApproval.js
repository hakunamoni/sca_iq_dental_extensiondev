define("Dental.DentalOrderApproval.DentalOrderApproval", [
  ...
  return {
    mountToApp: function mountToApp(container) {
      ...
      CartSummaryView.prototype.getContext = _.wrap(
      ...
      HeaderMiniCartView.prototype.getContext = _.wrap(
      ...
      _.extend(CartSummaryView.prototype, {
        ...
        placeApprovalOrder: function () {
          ...
          jQuery
            .ajax({
              url:
                "/app/site/hosting/scriptlet.nl?script=customscript_sl_supervisor_get_order&deploy=customdeploy_sl_supervisor_get_order&compid=" +
